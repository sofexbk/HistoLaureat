...
export const Landing = () => {
  ...
  return (
    <>
      ...
      <SubmitButton 
              property1='default'
              className='toggle-button sm:visible md:invisible lg:invisible xl:invisible ml-16'
              buttonTxt={isPostVisible ? 'Show Stages' : 'Show Posts'}
              icon={Icons.ArrowsRightLeftIcon}
              onclick={handleToggle}
            />
        <div className='flex flex-row min-h-screen min-w-screen flex-wrap items-start justify-between w-full lg:hidden  '>
          {isPostVisible ? (
        ...
        <div className='flex flex-row min-h-screen min-w-screen flex-wrap items-start justify-between w-full sm:hidden lgg:hidden'>
          <div className='flex-1 shrink-0 flex flex-row flex-wrap items-start justify-center gap-[10px] '>
            <div className='flex-1 flex flex-col items-start justify-start py-0 px-10 box-border gap-[20px] min-w-[600px] max-w-[1200px]'>
              <div className='self-stretch relative font-extrabold '>
                Postes
