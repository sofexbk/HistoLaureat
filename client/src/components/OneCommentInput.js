          ...
          <div class='sm:col-span-3'>
            <div class='mt-2'>
              <input
                ...
                class='block w-full rounded-md border-0 font-poppins text-lg py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-aliceblue-100 sm:text-sm sm:leading-6'
              ></input>
            </div>
          </div>
          <button
            ...
            class='cursor-pointer flex items-center pl-4 w-fit h-full border-none rounded-lg bg-primary-500 p-2  leading-normal text-white drop-shadow-md transition duration-300 ease-in-out hover:bg-primary-600'
          >
            <svg
