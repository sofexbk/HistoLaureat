...
function AdminCard() {
  ...
  return (
    <>
      {stats && (
        <div className="grid grid-cols-1 gap-4 px-4 mt-8 sm:grid-cols-4 sm:px-8 mb-8">
          ...
          <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
              ...
              <p className="text-3xl">{stats.postesCount}</p>
            </div>
          </div>
          <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
          ...
          <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
            ...
            <div className="px-4 text-gray-700">
              <h3 className="text-sm tracking-wider">Total Stages</h3>
              <p className="text-3xl">{stats.stagesCount}</p>
            </div>
          </div>
        </div>
      )}
